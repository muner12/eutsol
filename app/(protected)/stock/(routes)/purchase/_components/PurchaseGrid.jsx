...
const PurchaseGrid = () => {
    ...
    const [head, setHead] = useState([{ title: '', slector: '', Wid: 0  },{ title: 'SubItem', slector: 'PART_NUMBER', Wid: 270, customComp: PurchaseGridSku }, { title: 'Part', slector: '', customComp: CustomLotcell,  Wid: 150 }, { title: 'Cost', slector: 'COST', Wid: 100  ,customComp:PurchaseGridCost}, { title: 'LastCost', slector: 'LAST_COST', Wid: 120 , customComp:PurchaseGridCost }, { title: 'OhQty', slector: 'QTY_ONHAND', Wid: 120 }, { title: 'OrderQty', slector: 'QUANTITY', Wid: 120 , customComp:PurchaseGridOrdQnt }, { title: 'UOM', slector: 'CONVERSION_INTO_STOCKING_UOM', Wid: 120 }, { title: 'Conv', slector: 'CONVERSION_INTO_STOCKING_UOM', Wid: 120 }, { title: 'CaseQty', slector: 'CaseQty', Wid: 120 }, { title: 'Split', slector: 'Split', Wid: 120 ,  customComp:PurchaseSiplitSubgrid }, { title: 'Batch', slector: 'Batch', Wid: 120 }, { title: 'Expiry', slector: 'EXPIRY_DATE', Wid: 170 , date:true }])
    ...
    return (
        <div>
            <GridTable head={head} row={rowData} setHead={setHead} />
        </div>
    )
}
