...
const PurchaseGrid = () => {
    ...
    const [head, setHead] = useState([{ title: 'SubItem', slector: 'PART_NUMBER', Wid: 270, customComp: ModalOpen }, { title: 'Part', slector: 'BARCODE_NUMBER', Wid: 120 }, { title: 'Cost', slector: 'COST', Wid: 100  ,customComp:PurchaseGridCost}, { title: 'LastCost', slector: 'LAST_COST', Wid: 120 , customComp:PurchaseGridCost }, { title: 'OhQty', slector: 'QTY_ONHAND', Wid: 120 }, { title: 'OrderQty', slector: 'QUANTITY', Wid: 120 }, { title: 'UOM', slector: 'CONVERSION_INTO_STOCKING_UOM', Wid: 120 }, { title: 'Conv', slector: 'CONVERSION_INTO_STOCKING_UOM', Wid: 120 }, { title: 'CaseQty', slector: 'CaseQty', Wid: 120 }, { title: 'Split', slector: 'Split', Wid: 120 ,  customComp:PurchaseSiplitSubgrid }, { title: 'Batch', slector: 'Batch', Wid: 120 }, { title: 'Expiry', slector: 'EXPIRY_DATE', Wid: 120 }])
