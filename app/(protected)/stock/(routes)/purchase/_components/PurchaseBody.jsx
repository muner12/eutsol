  ...
  return (
    <div className=' w-full    '>
        <div className=' h-full w-full  '>
          <div className=''>
        <GridTable head={head} row={data?.Result} setHead={setHead} setSubHead={setSubHead} subHead={subHead}  GridTitle='Active' GridColor="indigo-400" GridColaps={false} />
        </div>
        <div className='my-5'>
        <GridTable head={head} row={compRow} setHead={setHead} setSubHead={setSubHead} subHead={subHead}  GridTitle='Completed' GridColor="green-400" GridColaps={true} />
        </div>
        </div>
    </div>
  )
