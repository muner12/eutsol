  ...
  return (
    <div className=" h-[88vh]   ">
      ...
      {/* <PurchaseForm/> */}
        ...
        <div className="lgdesktop:h-[15vh] desktop:h-[25vh] laptop:h-[25vh]  tablet:h-[25vh] h-[25vh]">
          <DashbordNav heading="Purchase Order" ptext="Welcome to contacts board! here you can store manage all of your contacts " />

        </div>

        <div className="overflow-auto pl-5 lgdesktop:h-[73vh] desktop:h-[63vh] laptop:h-[63vh] tablet:h-[63vh] h-[63vh] w-full ">
          <PurchaseBody />
        </div>
