...
const ModalWithTabs = ({ heading, tagline, tabs, isOpen, onOpenModal, onCloseModal }) => {
  ...
  return (
    <div className='p-2'>
      ...
      <button onClick={onOpenModal} className="text-blue-500 hover:underline">
      </button>
...
{isOpen && (
  ...
  <div className="bg-white p-2 rounded-md flex justify-between ">
    ...
    <div className="flex space-x-2  justify-end ml-auto">
      <SlArrowDown className='p-2 text-[1.7rem] font-bold border border-gray-200 text-gray-700 rounded-md hover:bg-gray-200' onClick={onCloseModal} />
      <SlArrowUp className='p-2 text-[1.7rem] font-bold border border-gray-200 text-gray-700 rounded-md hover:bg-gray-200' onClick={onCloseModal} />
      <TbDots className='p-2 text-[1.7rem] font-extrabold text-gray-500 rounded-md hover:bg-gray-200' onClick={onCloseModal} />
      <RxCross1 onClick={onCloseModal} className="p-2 text-gray-700 text-[1.8rem] rounded-md hover:bg-gray-200 cursor-pointer" />
    </div>
  </div>
